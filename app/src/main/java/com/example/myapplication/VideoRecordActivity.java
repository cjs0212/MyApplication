...
public class VideoRecordActivity extends AppCompatActivity {
    ...
    /**
     * An {@link com.example.myapplication.AutoFitTextureView} for camera preview.
     */
    private com.example.myapplication.AutoFitTextureView mTextureView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = (com.example.myapplication.AutoFitTextureView) findViewById(R.id.texture);
        ...
        findViewById(R.id.info).setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog show = new AlertDialog.Builder(VideoRecordActivity.this)
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(VideoRecordActivity.this, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            finish();
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(VideoRecordActivity.this, "Video saved: " + mNextVideoAbsolutePath,
